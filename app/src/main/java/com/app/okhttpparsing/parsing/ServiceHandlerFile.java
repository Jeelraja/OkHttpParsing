...
public class ServiceHandlerFile extends AsyncTask<Void, Void, Boolean> {
     ...
     */
    public ServiceHandlerFile(Activity activity, String type, String mUrl, HashMap<String, String> Paramter, boolean showinbuiltPorgressbar, int requestCode) {
        mActivity = activity;
     ...
     * @param showinbuiltPorgressbar
     */
    public ServiceHandlerFile(Activity activity, String type, String mUrl, RequestBody Paramter, boolean showinbuiltPorgressbar, int requestCode) {
        mActivity = activity;
        LocalshowinbuiltPorgressbar = showinbuiltPorgressbar;
        lType = type;
...
//		mWakeHimUp.release();
    ...
    public String urlResponsePost() {
        ...
        String mRespons = "";
        try {
            Log.i("SharedToken", "++" + AppSharedPref.getInstance(mActivity).getDataString(AppSharedPref.loginTokenKey));
